...
## Setup
If a setup (especially the Duckiebot) is already prepared, you might continue with the next chapter. See <a class="only_number" href="#dw_setup"></a>. _Please mind that the hardware benchmark results aren't fully comparable, as the benchmark aims to compare different hardware setups using the same software._
